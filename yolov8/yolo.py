...
from yolov8.nets.yolo import YoloBody
from yolov8.utils.utils import (cvtColor, get_classes, preprocess_input,
                         resize_image, show_config)
from yolov8.utils.utils_bbox import DecodeBox
...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : './yolov8/model_data/best.pth',
        "classes_path"      : './yolov8/model_data/voc_classes.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            num_classes.append(int(predicted_class))
            box             = top_boxes[i]
            score           = top_conf[i]
